...
public class OldAntiPhase extends JavaPlugin implements Listener
{
    ...
    public void onPearlLaunch(final ProjectileLaunchEvent event) {
        ...
        if (block != null && (block.getRelative(BlockFace.UP).getType() == Material.ACACIA_FENCE_GATE
            ...
            new BukkitRunnable() {
                public void run() {
                    if (OldAntiPhase.getInstance().getConfig().getBoolean("Invalid-Pearl-Remove-Timer")) {
                        OldAntiPhase.getInstance().getTimer().cooldown.remove(player.getUniqueId());
                    }
                }
            }.runTaskLater((Plugin)this, 2L);
            if (this.getConfig().getBoolean("return-pearl")) {
    ...
    public void onClip(final PlayerTeleportEvent e) {
        ...
        if (e.getCause() != null && e.getCause() == PlayerTeleportEvent.TeleportCause.ENDER_PEARL && p.getItemInHand().getType() == Material.ENDER_PEARL) {
            ...
            if (to.getBlock().getRelative(BlockFace.UP).getType().isSolid() 
            		...
            		&& !this.isEnchantmentTable(to.getBlock()) 
            		&& to.getBlock().getType() != Material.FENCE_GATE && to.getBlock().getType() != Material.TRAP_DOOR) {
                if (this.getConfig().getBoolean("Invalid-Pearl-Command")) {
                ...
                new BukkitRunnable() {
                    public void run() {
                        if (OldAntiPhase.getInstance().getConfig().getBoolean("Invalid-Pearl-Remove-Timer")) {
                            OldAntiPhase.getInstance().getTimer().cooldown.remove(p.getUniqueId());
                        }
                    }
                }.runTaskLater((Plugin)this, 2L);
                if (this.getConfig().getBoolean("return-pearl")) {
            ...
            if (to.getBlock().getRelative(BlockFace.UP).getType() == Material.FENCE_GATE && to.getBlock().getRelative(BlockFace.SELF).getType() == Material.FENCE_GATE && !((Gate)to.getBlock().getRelative(BlockFace.SELF).getState().getData()).isOpen() && to.getBlock().getRelative(BlockFace.DOWN).getType().isSolid()) {
            	if (this.getConfig().getBoolean("Invalid-Pearl-Command")) {
                    Bukkit.getServer().dispatchCommand((CommandSender)Bukkit.getConsoleSender(), this.getConfig().getString("Command").replace("%player%", p.getName()));
                }
                HCFactions.getInstance().getEnderpearlHandler().quit(p);
            ...
            if (to.getBlock().getRelative(BlockFace.UP).getType() != Material.FENCE_GATE && to.getBlock().getRelative(BlockFace.SELF).getType() == Material.FENCE_GATE && !((Gate)to.getBlock().getRelative(BlockFace.SELF).getState().getData()).isOpen() && to.getBlock().getRelative(BlockFace.DOWN).getType() == Material.FENCE_GATE && !((Gate)to.getBlock().getRelative(BlockFace.DOWN).getState().getData()).isOpen()) {
            	if (this.getConfig().getBoolean("Invalid-Pearl-Command")) {
                    Bukkit.getServer().dispatchCommand((CommandSender)Bukkit.getConsoleSender(), this.getConfig().getString("Command").replace("%player%", p.getName()));
                }
                HCFactions.getInstance().getEnderpearlHandler().quit(p);
            ...
            if (!getInstance().getConfig().getBoolean("Chest-Pearl") && (to.getBlock().getRelative(BlockFace.SELF).getType() == Material.CHEST || to.getBlock().getRelative(BlockFace.SELF).getType() == Material.TRAPPED_CHEST) && to.getBlock().getRelative(BlockFace.UP).getType().isSolid() && to.getBlock().getRelative(BlockFace.UP).getType() != Material.FENCE_GATE) {
            	if (this.getConfig().getBoolean("Invalid-Pearl-Command")) {
                    Bukkit.getServer().dispatchCommand((CommandSender)Bukkit.getConsoleSender(), this.getConfig().getString("Command").replace("%player%", p.getName()));
                }
                HCFactions.getInstance().getEnderpearlHandler().quit(p);
    ...
    public static OldAntiPhase getInstance() {
        return OldAntiPhase.instance;
    }
